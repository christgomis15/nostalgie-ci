...
const SECTIONS = [
  ...
  { href: '/admin/sujets', label: 'Sujets du jour', desc: 'Publier un sujet sur lequel les auditeurs réagissent (/sujets)' },
  { href: '/admin/affiches', label: 'Affiches partenaires', desc: "Publier les affiches d'événements, affichées en intro sur l'accueil selon leur date" },
